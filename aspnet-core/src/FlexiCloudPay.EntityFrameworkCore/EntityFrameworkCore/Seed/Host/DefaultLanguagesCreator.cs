...
namespace FlexiCloudPay.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = FlexiCloudPayConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FlexiCloudPayDbContext context)
        {
            _context = context;
        }
