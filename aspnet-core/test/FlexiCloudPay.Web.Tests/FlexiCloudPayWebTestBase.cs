...
{
    public abstract class FlexiCloudPayWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FlexiCloudPayWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FlexiCloudPayWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<FlexiCloudPayDbContext> action)
        {
            using (var context = IocManager.Resolve<FlexiCloudPayDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<FlexiCloudPayDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<FlexiCloudPayDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FlexiCloudPayDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FlexiCloudPayDbContext, Task<T>> func)
        {
            T result;
